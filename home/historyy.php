                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
									   ...
									   <tr>
                                        ...
                                        ?>
                                        <tr><td><td><td><td><td><td><td><td>TOTAL<td><span>&#8358</span><?php echo number_format($count); ?><td>
                                        
                                            </td></td></td></td></td></td></td></td></td></td></tr>
                                    <?php
                                        echo '<a href="historyy" class="btn btn-primary">BACK</a><a href="generate?tid='.$search.'" class="btn btn-success">generate receipt</a>';
									}else{
										echo '<tr><td><td>No Record Found!</td></td></tr>
                                        <a href="historyy" class="btn btn-success">BACK</a>';
